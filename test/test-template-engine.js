...
describe.todo('future html errors', () => {
  ...
  it('throws for declarative shadow roots', () => {
    ...
    const expectedMessage = 'Declarative shadow roots are not yet supported.';
    assertThrows(callback, expectedMessage);
  });
});
