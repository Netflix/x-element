...
export default class XElement extends HTMLElement {
    ...
    static "__#4@#analyzeConstructor"(constructor: any): void;
    static "__#4@#validateProperties"(constructor: any, properties: any, entries: any): void;
    static "__#4@#validateProperty"(constructor: any, key: any, property: any): void;
    static "__#4@#validatePropertyAttribute"(constructor: any, key: any, property: any, attribute: any): void;
    static "__#4@#propertyIsCyclic"(property: any, inputMap: any, seen?: Set<any>): boolean;
    static "__#4@#validateListeners"(constructor: any, listeners: any, entries: any): void;
    static "__#4@#mutateProperty"(constructor: any, propertyMap: any, key: any, property: any): void;
    static "__#4@#addPropertyInitial"(constructor: any, property: any): void;
    static "__#4@#addPropertyDefault"(constructor: any, property: any): void;
    static "__#4@#addPropertySync"(constructor: any, property: any): void;
    static "__#4@#addPropertyReflect"(constructor: any, property: any): void;
    static "__#4@#addPropertyCompute"(constructor: any, property: any): void;
    static "__#4@#addPropertyObserve"(constructor: any, property: any): void;
    static "__#4@#constructHost"(host: any): void;
    static "__#4@#createInternal"(host: any): any;
    static "__#4@#createProperties"(host: any): any;
    static "__#4@#connectHost"(host: any): void;
    static "__#4@#disconnectHost"(host: any): void;
    static "__#4@#initializeHost"(host: any): boolean;
    static "__#4@#upgradeOwnProperties"(host: any): void;
    static "__#4@#getPreUpgradePropertyValue"(host: any, property: any): {
        value: any;
        found: boolean;
    };
    static "__#4@#initializeProperty"(host: any, property: any): void;
    static "__#4@#addListener"(host: any, element: any, type: any, callback: any, options: any): void;
    static "__#4@#addListeners"(host: any): void;
    static "__#4@#removeListener"(host: any, element: any, type: any, callback: any, options: any): void;
    static "__#4@#removeListeners"(host: any): void;
    static "__#4@#getListener"(host: any, listener: any): any;
    static "__#4@#updateHost"(host: any): void;
    static "__#4@#toPathString"(host: any): string;
    static "__#4@#invalidateProperty"(host: any, property: any): Promise<void>;
    static "__#4@#getPropertyValue"(host: any, property: any): any;
    static "__#4@#validatePropertyValue"(host: any, property: any, value: any): void;
    static "__#4@#setPropertyValue"(host: any, property: any, value: any): void;
    static "__#4@#serializeProperty"(host: any, property: any, value: any): any;
    static "__#4@#deserializeProperty"(host: any, property: any, value: any): any;
    static "__#4@#propertyHasAttribute"(property: any): boolean;
    static "__#4@#getTypeName"(value: any): any;
    static "__#4@#notNullish"(value: any): boolean;
    static "__#4@#typeIsWrong"(type: any, value: any): boolean;
    static "__#4@#camelToKebab"(camel: any): any;
    static "__#4@#constructors": WeakMap<WeakKey, any>;
    static "__#4@#hosts": WeakMap<WeakKey, any>;
    static "__#4@#propertyKeys": Set<string>;
    static "__#4@#serializableTypes": Set<StringConstructor | BooleanConstructor | NumberConstructor>;
    static "__#4@#caseMap": Map<any, any>;
    static "__#4@#prototypeInterface": Set<string>;
    /**
